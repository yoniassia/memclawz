...
Usage:
  ...
  python3 memclawz_server/embed_bridge.py --reindex

  # Search using local embeddings
  python3 memclawz_server/embed_bridge.py --search "what is memclawz"

  # Generate embedding for text (outputs JSON array)
  python3 memclawz_server/embed_bridge.py --embed "hello world"
